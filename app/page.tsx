    ...
    <main className="page-shell">
      <section className="product-layout" aria-labelledby="product-title">
        ...
        <div className="purchase-stack">
          <section className="panel purchase-panel">
            ...
            <h1 id="product-title">Limited Runner</h1>
            <p className="muted">SKU hot-001 · one hot product · event-sourced checkout</p>
            <div className="price">TWD 1,000</div>
            <div className="inventory-row">
              <div>
                <strong>Available now: 100</strong>
            ...
            <div className="status-list">
              ...
              <div className="status-row">
                <div>
                  ...
                  <p className="muted">1 of 3 products is reserved. Remaining products are processing.</p>
                </div>
      ...
      <details className="floating-cart">
        <summary aria-label="Cart checkout progress">
          ...
          <span className="cart-count" aria-label="3 products in cart">
            3
          </span>
            ...
            {cartItems.map((item) => (
              <div className="cart-item" key={item.name}>
                ...
                {item.status === "reserved" ? (
                  ...
                  <span className="spinner" aria-label={`${item.name} processing`} />
                )}
              </div>
            ))}
          </div>
